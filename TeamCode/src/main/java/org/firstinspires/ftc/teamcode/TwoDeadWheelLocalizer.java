...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -182.8836423936; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 312.3616632302; // x position of the perpendicular encoder (in tick units)
    }
